...
class Api
{
  ...
  'foogetbar' => 'FooGetBar',
     ...
     *
     * @param  array $options
     * @throws \Baz\Exceptions\Configuration
     */
     ...
     * @return \Baz\Abstractions\Command
     * @throws \Baz\Exceptions\Exception
     */
    public function __call($method, $arguments)
    {
        ...
        if (!array_key_exists($lower, $this->commandsCache)) {
            $this->commandsCache[$lower] = new \ReflectionClass('\Baz\Commands\\' . $this->commands[$lower]);
        }
